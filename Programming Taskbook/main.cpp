...
void main()
{
	...
	default:cout << "нет такого дн€ недели"; break;
	}
#endif // CASE_1
	...
	int b = a / 10;
	cout << "лева€ цифра :\t" << b << endl;
	int c = a % 10;
	cout << "права€ цифра:\t" << c << endl;
	...
	int res = a % 10;
	cout << "последн€ цифра(единицы):\t" << res << endl;
	int res1 = a % 100 / 10;
	cout << "средн€€ цифра(дес€тки):\t" << res1;
#endif // INTEGER_10
